                    ...
                    <div class="yui-u first" style="background-color:transparent">
                      ...
                      <div class="resultitem">
                        ...
                        {elseif !empty($resource.ils_details.title)}
                          <p class="resultItemLine1"><a href="{$url}/Search/Barcode?barcode={$resource.ils_details.barcode|escape:"url"}" class="title">{$resource.ils_details.title|escape}</a></p>
                        ...
                        {else}
                          <p>{translate text='by'} <a href="{$url}/Author/Home?author={$resource.ils_details.author|escape:"url"}">{$resource.ils_details.author|escape}</a></p>
                        {/if}
                        {if $resource.tags}
