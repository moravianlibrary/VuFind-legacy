...
<div id="bd">
  <div id="yui-main" class="content">
    ...
    {if $user->cat_username}
      ...
      {/if}
      <p class="error"><b>{translate text='You can find books ready for you to lend home on the bookshelf number'}: {$profile.barcode|substr:-2:2|escape}</b></p>
      <table class="citation" dwidth="100%">
        ...
        <tr><th>{translate text='Barcode'}:</th><td>{$profile.barcode|escape}</td></tr>
        <tr><th>{translate text='Expire'}:</th><td>{$profile.expire|escape}</td></tr>
      </table>
      {if $showHomeLibForm}
