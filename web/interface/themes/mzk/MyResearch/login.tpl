  ...
  <div id="yui-main" class="content">
    <div class="yui-b first">
      ...
      {if $authMethod == 'Shibboleth'}
         <div class="resulthead"><h3><a href="{$sessionInitiator}">{translate text="Institutional Login"}</a></h3></div>
      {else}
         <div class="resulthead"><h3>{translate text='Login'}</h3></div>
      {/if}
      {if $guestLogin}
         <div class="resulthead"><h3><a href="/MyResearch/GuestLogin?redirect={$currentURL|escape:"url"}">{translate text='Login as a guest'}</a></h3></div>
      {/if}
      <div class="page">
