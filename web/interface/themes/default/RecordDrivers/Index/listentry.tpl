  ...
  <div class="yui-u first">
    ...
    <div class="resultitem">
      <div class="resultItemLine1">
		<a href="{$url}/Record/{$listId|escape:"url"}" class="title">{$listTitle|escape}</a>
	  </div>
      <div class="resultItemLine2">
	  {if $listAuthor}
        {translate text='by'}: <a href="{$url}/Author/Home?author={$listAuthor|escape:"url"}">{$listAuthor|escape}</a>
      {/if}
	  </div>
